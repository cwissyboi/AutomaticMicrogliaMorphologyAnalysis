...
# SBATCH --mem=32384          # Request memory (MB) per node. Default is 1024MB (1GB). For multiple tasks, specify --mem-per-cpu instead
...
source activate /home/nfs/ccharlesworth/segmentation_conda
# source activate /tudelft.net/staff-umbrella/AutomaticMicrogliaMorphologyAnalysis/preprocess_venv
