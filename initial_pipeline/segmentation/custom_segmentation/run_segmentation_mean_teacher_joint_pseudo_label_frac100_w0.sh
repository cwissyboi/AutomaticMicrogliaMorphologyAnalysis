...
#SBATCH --mem=8G
#SBATCH --gres=gpu:1
#SBATCH --output=run_segmentation_mean_teacher_joint_pseudo_label_frac100_w0.out
#SBATCH --error=run_segmentation_mean_teacher_joint_pseudo_label_frac100_w0.err
